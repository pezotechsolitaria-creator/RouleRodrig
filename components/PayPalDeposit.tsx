...
export default function PayPalDeposit({
  ...
  const T = {
    ...
    cr: { pay: "Pey depo pou konfirmen", payFull: "Pey tou", deposit: "Depo", full: "Tou", fee: `avek ${PAYPAL_FEE_PERCENT}% fre PayPal`, paid: "Peyman resevwar — rezervasion konfirmen! 🎉", secure: "Peyman sekirize ar PayPal", firstPaid: "Premie depo ki nou gagne gard veikil la — bann dat pa reserve tank nou pa finn gagn li.", err: "Peyman pa finn pas. Reisi ankor ouswa pey par bank." },
  }[language] ?? {
