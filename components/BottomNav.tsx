...
export default function BottomNav() {
  ...
  const item = (tab: NavTab) => {
    ...
    if (tab.action === "tiroule") {
      return (
        ...
        >
          ...
          <span className="font-dm text-[10px] font-medium leading-none text-dark">
            {label}
          </span>
        </button>
      );
    ...
    return (
      ...
      >
        ...
        />
        <span className="font-dm text-[10px] font-medium leading-none">
          {label}
        </span>
      </Link>
    );
  ...
  return (
    <>
      {/* The strip this bar floats over used to be reserved by `pb-16` on
          <body> in app/layout.tsx — on EVERY page, including the ones this
