-- The driver board has to say WHAT KIND of errand it is. "Pay a bill" and
-- "queue at a counter" are different amounts of somebody's afternoon, and a
-- driver pricing them from the free text alone is guessing.
