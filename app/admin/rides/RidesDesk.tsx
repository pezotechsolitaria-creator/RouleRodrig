...
// A ride end as the desk shows it: the label, made tappable when the
// customer's device gave us a pin. "Ma position actuelle" is a LABEL, not a
// place — the place is the coordinates, and the operator's next act is always
// to open them on a map (to brief a driver, or to judge who is close). Plain
// text here meant copying nothing into Google Maps by hand, which is exactly
// what the owner was doing with a real booking on screen.
function RideEnd({
  label, lat, lng,
