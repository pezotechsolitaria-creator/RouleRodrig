...
import MarketplaceOps from "./MarketplaceOps";

// Server-side gate. Same cookie session as the rest of /admin. Every
// /api/admin/marketplace-ops/* route re-checks independently, so this redirect
    ...
    <main className="min-h-screen bg-dark px-4 pb-16 pt-10 text-offwhite">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mt-3 flex flex-wrap items-start justify-between gap-3">
          <div>
            <p className="font-bebas text-[11px] tracking-[0.3em] text-yellow">MARKETPLACE OPERATIONS</p>
            <h1 className="mt-1 font-syne text-2xl font-extrabold text-offwhite">The shop desk</h1>
            <p className="mt-1.5 max-w-2xl font-dm text-sm text-muted">
              The same desk you have for food, for every other shop on the platform. Take an order
              through, check a proof of payment, and fix a price or a stock count for a seller who
              would rather phone you than open a laptop. Sellers keep their own dashboard —
              nothing here takes it away from them.
            </p>
          </div>
          <Link
            href="/browse"
          ...
          >
            View the shop pages <ExternalLink size={13} />
          </Link>
        </div>
