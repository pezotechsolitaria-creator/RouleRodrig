...
export async function POST(req: NextRequest) {
  ...
  // Marketplace product orders are deliberately absent: per the marketplace
  // business rules, card/PayPal is reserved for vehicle rentals and place
  // bookings, while the marketplace takes cash, bank transfer or merchant QR
  // only. See the matching note in capture-order/route.ts.
