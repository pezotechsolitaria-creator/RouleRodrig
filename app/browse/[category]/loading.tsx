    ...
    <div className="min-h-screen bg-dark">
      ...
      <div className="fixed top-0 inset-x-0 z-50 bg-dark/80 backdrop-blur-xl border-b border-dark-border">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="h-9 w-24 rounded-lg rr-shimmer" />
          <div className="flex gap-3">
            <div className="h-6 w-6 rounded-full rr-shimmer" />
            <div className="h-6 w-6 rounded rr-shimmer" />
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 pt-28 md:pt-32 pb-1">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-full rr-shimmer" />
          <div className="h-4 w-52 rounded rr-shimmer" />
        </div>
      </div>
      ...
      <div className="border-b border-white/5 mt-3">
        <div className="max-w-7xl mx-auto px-6 py-3 flex gap-2.5">
          {[96, 84, 128].map((w, i) => (
            <div key={i} className="h-10 rounded-full rr-shimmer" style={{ width: w }} />
          ))}
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-14 md:py-20">
        ...
        <div className="h-14 w-64 rounded-lg rr-shimmer mb-3" />
        <div className="h-4 w-80 max-w-[80%] rounded rr-shimmer mb-12" />
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[0, 1].map((i) => (
            <div key={i} className="bg-dark-card rounded-2xl border border-dark-border overflow-hidden">
              <div className="h-[320px] md:h-[420px] rr-shimmer" />
