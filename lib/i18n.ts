...
const translations = {
  en: {
    ...
    booking: {
      ...
      successDesc:    "We're confirming this vehicle with its owner right now. As soon as it's confirmed we'll email you a link to pay and secure it. Nothing is charged until then.",
      ...
      checkingNote:   "If it isn't free we'll say so straight away and suggest something similar — you will never be charged for a vehicle we cannot provide.",
      ...
      requestNote:    "Sending this does not hold the vehicle — the deposit does. Another traveller can still book these dates until it is paid.",
    ...
    map: {
      ...
      title:    "ISLAND GUIDE",
      subtitle: "Discover Rodrigues' hidden gems. Tap any photo to zoom, or tap directions for live distance from where you are.",
    ...
    cta: {
      eyebrow:  "GET STARTED",
      title:    "READY TO RIDE?",
      subtitle: "Book your scooter online in 60 seconds. Cancel more than 48h before and 80% of your deposit is refunded.",
      bookNow:  "Book Now",
    },
    ...
    taxi: {
      ...
      from:           "From",
      priceNote:      "We will confirm the price with you — no charge until you agree.",
      whatsapp:       "WhatsApp",
      call:           "Call",
      reviewsRate:    "Reviews & rate",
      rate:           "Rate this driver",
      fareNote:       "We will confirm the price with you — no charge until you agree. Every driver sets their own fare; Roulé Rodrigues never takes payment for a ride.",
    ...
    food: {
      ...
      previewEmpty: "Pick a craving to start — or just tap the button and tell us in your own words.",
      clear: "Clear",
      ...
      areas: { north: "North / Port Mathurin", east: "East coast", south: "South", west: "West / La Ferme", anywhere: "Anywhere" },
      when: { tonight: "Tonight", tomorrow: "Tomorrow", thisweek: "This week", lunch: "For lunch", flexible: "Flexible" },
      steps: { tell: "Tell us your craving", match: "We match you", book: "We book your table" },
  ...
  fr: {
    ...
    booking: {
      ...
      successDesc:    "Nous confirmons ce véhicule auprès de son propriétaire. Dès que c'est confirmé, nous vous enverrons un lien pour payer et le réserver. Rien n'est débité avant.",
      checkingTitle:  "La suite",
      checkingStep1:  "Nous vérifions que le véhicule est libre à vos dates.",
      checkingStep2:  "Nous vous écrivons pour confirmer — en général sous quelques heures.",
      checkingStep3:  "Vous payez, et le véhicule est à vous pour ces dates.",
      checkingNote:   "S'il n'est pas libre, nous vous le dirons tout de suite et vous proposerons un équivalent — vous ne serez jamais débité pour un véhicule que nous ne pouvons pas fournir.",
      ...
      requestNote:    "Envoyer ce formulaire ne bloque pas le véhicule — c'est l'acompte qui le bloque. Un autre voyageur peut encore réserver ces dates.",
    ...
    map: {
      ...
      subtitle: "Découvrez les trésors cachés de Rodrigues. Touchez une photo pour l'agrandir, ou « itinéraire » pour la distance depuis votre position.",
    ...
    cta: {
      eyebrow:  "COMMENCER",
      title:    "PRÊT À ROULER ?",
      subtitle: "Réservez votre scooter en ligne en 60 secondes. Annulez plus de 48 h avant : 80 % de l'acompte remboursé.",
      bookNow:  "Réserver",
    },
    reviews: {
    ...
    taxi: {
      ...
      from:           "À partir de",
      priceNote:      "Nous confirmerons le prix avec vous — rien n’est débité avant votre accord.",
      whatsapp:       "WhatsApp",
      call:           "Appeler",
      reviewsRate:    "Avis & noter",
      rate:           "Noter ce chauffeur",
      fareNote:       "Nous confirmerons le prix avec vous — rien n’est débité avant votre accord. Chaque chauffeur fixe son tarif ; Roulé Rodrigues n’encaisse jamais une course.",
    ...
    food: {
      ...
      subtitle: "Dites-nous ce qui vous fait envie — on trouve et réserve la table.",
      ...
      previewEmpty: "Choisissez une envie pour commencer — ou touchez le bouton et dites-nous en quelques mots.",
      clear: "Effacer",
      labelCraving: "Envies",
      labelBudget: "Budget",
      ...
      areas: { north: "Nord / Port Mathurin", east: "Côte est", south: "Sud", west: "Ouest / La Ferme", anywhere: "N'importe où" },
      when: { tonight: "Ce soir", tomorrow: "Demain", thisweek: "Cette semaine", lunch: "Pour le déjeuner", flexible: "Flexible" },
      steps: { tell: "Dites-nous votre envie", match: "On vous oriente", book: "On réserve votre table" },
      prefill: "Bonjour Roule Rodrigues 👋 J'aimerais votre aide pour trouver un bon endroit où manger à Rodrigues.",
    },
  },
  ...
  cr: {
    ...
    booking: {
      ...
      successDesc:    "Nou pe konfirm sa veikil la ar so proprieter. Kan li konfirme, nou avoy ou enn lien pou peye ek blok li. Nanye pa debite avan sa.",
      ...
      checkingNote:   "Si li pa lib, nou dir ou deswit ek propoz ou enn lot parey — nou pa pou zame debit ou pou enn veikil ki nou pa kapav donn ou.",
      ...
      requestNote:    "Avoy sa form la pa blok veikil la — se depo ki blok li. Enn lot vwayazer kapav ankor rezerv sa bann dat la.",
    ...
    taxi: {
      ...
      from:           "Apartir",
      priceNote:      "Nou pou konfirm pri-la ar ou — nanye pa debite avan ou dakor.",
      whatsapp:       "WhatsApp",
      call:           "Apele",
      reviewsRate:    "Lavi & note",
      rate:           "Note sa chofer la",
      fareNote:       "Nou pou konfirm pri-la ar ou — nanye pa debite avan ou dakor. Sak chofer fixe so prop pri; Roulé Rodrigues zame pran kas pou enn kours.",
    ...
    food: {
      ...
      previewEmpty: "Swazir enn anvi pou koumanse — ou zis tous bouton la ek dir nou dan ou mo.",
      clear: "Efase",
      labelCraving: "Anvi",
      labelBudget: "Bidze",
      ...
      areas: { north: "Nor / Port Mathurin", east: "Lakot les", south: "Sid", west: "Lwes / La Ferme", anywhere: "Ninport kot" },
      when: { tonight: "Aswar", tomorrow: "Demen", thisweek: "Sa semenn la", lunch: "Pou midi", flexible: "Fleksib" },
      steps: { tell: "Dir nou ou anvi", match: "Nou trouv pou ou", book: "Nou rezerv ou latab" },
      prefill: "Bonzour Roule Rodrigues 👋 Mo bizin ou led pou trouv enn bon plas pou manze Rodrigues.",
    },
  },
} as const;
