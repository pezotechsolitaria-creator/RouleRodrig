...
const translations = {
  en: {
    ...
    eventPackages: {
      ...
      imageHint: "Give each tier its own picture — VIP should not look like Standard.",
      fileTypes: "JPG, PNG or WebP · up to 4 MB",
      priceNote: "Changing the price never changes what somebody already bought.",
      egDrink: "Complimentary drink",
      egEntrance: "Priority entrance",
      egView: "The best view in the house…",
    },
    eventScanner: {
      admittingTo: "Admitting to",
      startScanning: "Start scanning",
      pressStart: "Press start, then point at each ticket.",
      ticketCode: "Ticket code",
      pasteCode: "Paste or type the code from the ticket",
      checkTicket: "Check this ticket",
      notValid: "NOT VALID",
      cancelled: "This event is cancelled.",
    },
    eventStaff: {
      title: "STAFF & ACCESS",
      addDoorStaff: "Add door staff",
      giveAccess: "Give door access",
      theirName: "Their name",
      theirEmail: "Their email",
      scanOnly: "Scan only",
      invited: "Invited — hasn’t signed in yet",
      nobodyYet: "Nobody is set up for the door yet.",
    },
    eventManaged: {
    ...
    eventPayout: {
      ...
      accountNumber: "Account number",
      buyerNote: "Anything else the buyer should know (optional)",
      untilSetUp: "Until you set this up, nobody can buy a ticket to your event.",
    },
    eventCapacity: {
      title: "VENUE CAPACITY",
      label: "Venue capacity",
      noLimit: "No limit",
      hint: "Enter a whole number of at least 1, or leave it empty for no limit.",
    },
    eventPayments: {
      nonePending: "No payments waiting on you.",
    ...
    common: {
      ...
      liveLocationOnly: "Live location only works while you are on Rodrigues Island.",
      noAccountNeeded: "No account needed. Works even with this page closed.",
      notificationsBlocked: "Notifications are blocked for this site in your browser settings.",
      notificationPrefs: "Choose what you hear about. Turning something off stops the notification, not the service.",
      collectFromKitchen: "Collect it from the kitchen. No fee, and you get a code to show when you arrive.",
      collectionOnly: "Collection only right now",
      // The /food fulfilment switch. These three were hardcoded English in
      // components/food/FulfillmentBar.tsx, beside two strings that had been
      // translated all along — so a French visitor met "Vous avez envie de
      // quoi ?" and then "Collect in person / Delivered to you".
      deliveryPaused: "— delivery is paused.",
      chipPickup: "Collect in person",
      chipDelivered: "Delivered to you",
      weBringItToYou: "We bring it to you",
      weBringItFrom: "depending on the area.",
      shareLocationAtCheckout: "You share your location at checkout.",
      aiTripPlanner: "AI Trip Planner",
      chooseExperience: "Choose how you want to experience Rodrigues",
      afterDark: "AFTER DARK",
      curatedByLocals: "RODRIGUES · CURATED BY LOCALS",
      bookScooter: "Book a scooter",
      downloadReceipt: "Download receipt",
      tapOneDay: "Tap one day for a 1-day rental, or tap a return day for a longer trip.",
      validEmail: "Please enter a valid email address.",
    },
    a11yMore: {
      liveTrackingMap: "Live tracking map",
      mapStyle: "Map style",
      islandGuideMap: "Island guide map",
      heroSection: "Hero section",
      heroAlt: "Exploring Rodrigues Island at golden hour",
      marquee: "EXPLORE THE ISLAND • FEEL THE WIND • ROULE RODRIGUES •",
      vehicleFleet: "Vehicle fleet",
      recommendedPlaces: "Recommended places",
      nextMonth: "Next month",
      prevMonth: "Previous month",
      tripProgress: "Trip progress",
      pickupQr: "QR code for this pickup — scanned at the counter when you collect",
      whatsappChat: "Chat with us on WhatsApp",
      emergencyNumbers: "Emergency and useful numbers",
      ourPartners: "Our partners",
      appearance: "Appearance",
      islandEvents: "Island events",
      gettingAround: "Getting around Rodrigues",
  ...
  fr: {
    ...
    eventPackages: {
      title: "FORMULES DE BILLETS",
      addPackage: "Ajouter une formule",
      noPackages: "Aucune formule pour l’instant",
      createFirst: "Créer la première formule",
      whatsIncluded: "Ce qui est inclus",
      visibleToCustomers: "Visible par les clients",
      packageImage: "Image de la formule",
      imageHint: "Donnez une image à chaque formule — VIP ne doit pas ressembler à Standard.",
      fileTypes: "JPG, PNG ou WebP · jusqu’à 4 Mo",
      priceNote: "Changer le prix ne change jamais ce que quelqu’un a déjà acheté.",
      egDrink: "Boisson offerte",
      egEntrance: "Entrée prioritaire",
      egView: "La meilleure vue de la salle…",
    },
    eventScanner: {
      admittingTo: "Entrée pour",
      startScanning: "Commencer à scanner",
      pressStart: "Appuyez sur démarrer, puis visez chaque billet.",
      ticketCode: "Code du billet",
      pasteCode: "Collez ou tapez le code du billet",
      checkTicket: "Vérifier ce billet",
      notValid: "NON VALABLE",
      cancelled: "Cet événement est annulé.",
    },
    eventStaff: {
      title: "ÉQUIPE ET ACCÈS",
      addDoorStaff: "Ajouter une personne à l’entrée",
      giveAccess: "Donner l’accès à l’entrée",
      theirName: "Son nom",
      theirEmail: "Son e-mail",
      scanOnly: "Scan uniquement",
      invited: "Invité — ne s’est pas encore connecté",
      nobodyYet: "Personne n’est encore configuré pour l’entrée.",
    },
    eventManaged: {
    ...
    eventPayout: {
      ...
      accountNumber: "Numéro de compte",
      buyerNote: "Autre chose que l’acheteur doit savoir (facultatif)",
      untilSetUp: "Tant que ce n’est pas configuré, personne ne peut acheter de billet pour votre événement.",
    },
    eventCapacity: {
      title: "CAPACITÉ DU LIEU",
      label: "Capacité du lieu",
      noLimit: "Sans limite",
      hint: "Entrez un nombre entier d’au moins 1, ou laissez vide pour aucune limite.",
    },
    eventPayments: {
      nonePending: "Aucun paiement en attente de votre part.",
    ...
    common: {
      ...
      viewYourOrder: "Voir votre commande",
      checkIt: "Vérifier",
      ...
      liveLocationOnly: "La position en direct ne fonctionne que si vous êtes sur l’île Rodrigues.",
      noAccountNeeded: "Pas besoin de compte. Fonctionne même si cette page est fermée.",
      notificationsBlocked: "Les notifications sont bloquées pour ce site dans votre navigateur.",
      notificationPrefs: "Choisissez ce dont vous voulez être informé. Désactiver arrête la notification, pas le service.",
      collectFromKitchen: "À récupérer à la cuisine. Sans frais, et vous recevez un code à montrer sur place.",
      collectionOnly: "Retrait uniquement pour le moment",
      deliveryPaused: "— la livraison est suspendue.",
      chipPickup: "À récupérer sur place",
      chipDelivered: "Livré chez vous",
      weBringItToYou: "Nous vous l'apportons",
      weBringItFrom: "selon la zone.",
      shareLocationAtCheckout: "Vous indiquez votre position au moment de payer.",
      aiTripPlanner: "Planificateur de séjour",
      chooseExperience: "Choisissez comment vivre Rodrigues",
      afterDark: "LA NUIT",
      curatedByLocals: "RODRIGUES · CHOISI PAR LES HABITANTS",
      bookScooter: "Réserver un scooter",
      downloadReceipt: "Télécharger le reçu",
      tapOneDay: "Touchez un jour pour une location d’un jour, ou un jour de retour pour un séjour plus long.",
      validEmail: "Merci d’entrer une adresse e-mail valide.",
    },
    a11yMore: {
      liveTrackingMap: "Carte de suivi en direct",
      mapStyle: "Style de carte",
      islandGuideMap: "Carte du guide de l’île",
      heroSection: "Section principale",
      heroAlt: "L’île Rodrigues à l’heure dorée",
      marquee: "EXPLOREZ L’ÎLE • SENTEZ LE VENT • ROULE RODRIGUES •",
      vehicleFleet: "Notre flotte",
      recommendedPlaces: "Lieux recommandés",
      nextMonth: "Mois suivant",
      prevMonth: "Mois précédent",
      tripProgress: "Progression du trajet",
      pickupQr: "QR code de ce retrait — scanné au comptoir quand vous récupérez",
      whatsappChat: "Discutez avec nous sur WhatsApp",
      emergencyNumbers: "Numéros d’urgence et utiles",
      ourPartners: "Nos partenaires",
      appearance: "Apparence",
      islandEvents: "Événements de l’île",
      gettingAround: "Se déplacer à Rodrigues",
  ...
  cr: {
    ...
    eventPackages: {
      title: "BANN FORMIL BILE",
      addPackage: "Azout enn formil",
      noPackages: "Pankor ena formil",
      createFirst: "Kree premie formil la",
      whatsIncluded: "Seki inklir",
      visibleToCustomers: "Bann kliyan kapav trouve",
      packageImage: "Zimaz formil",
      imageHint: "Donn sak formil so prop zimaz — VIP pa bizin resanble Standard.",
      fileTypes: "JPG, PNG ouswa WebP · ziska 4 MB",
      priceNote: "Kan ou chanz pri, sa pa zame chanz seki enn dimounn finn deza aste.",
      egDrink: "Enn labwason ofer",
      egEntrance: "Lantre prioriter",
      egView: "Pli bon vi dan lasal…",
    },
    eventScanner: {
      admittingTo: "Lantre pou",
      startScanning: "Koumans skane",
      pressStart: "Tap lor koumanse, apre vize sak bile.",
      ticketCode: "Kod bile",
      pasteCode: "Kol ouswa tap kod ki lor bile la",
      checkTicket: "Verifie sa bile la",
      notValid: "PA VALAB",
      cancelled: "Sa levennman la finn anile.",
    },
    eventStaff: {
      title: "EKIP EK AKSE",
      addDoorStaff: "Azout enn dimounn lor laport",
      giveAccess: "Donn akse lor laport",
      theirName: "So nom",
      theirEmail: "So e-mail",
      scanOnly: "Zis skane",
      invited: "Invite — pankor konekte",
      nobodyYet: "Pankor ena personn lor laport.",
    },
    eventManaged: {
      title: "BILETRI ZERE",
    ...
    eventPayout: {
      title: "KOUMA OU GAGN OU KAS",
      accountHolder: "Dimounn ki ena kont la",
      accountNumber: "Nimero kont",
      buyerNote: "Lot kiksoz ki aster la bizin kone (si ou anvi)",
      untilSetUp: "Tank ou pa finn ranz sa, personn pa kapav aste enn bile pou ou levennman.",
    },
    eventCapacity: {
      title: "KAPASITE LANDRWA",
      label: "Kapasite landrwa",
      noLimit: "Pena limit",
      hint: "Met enn nomb antie omwin 1, ouswa les li vid si pena limit.",
    },
    eventPayments: {
      nonePending: "Pena peyman ki pe atann ou.",
      viewProof: "Get prev la",
      noProof: "Pena prev atase",
    },
    common: {
      tryAgain: "Reseye",
      dismiss: "Ferme",
      startOver: "Rekoumanse",
      backToTop: "Retourn anler",
      viewYourOrder: "Get ou komand",
      checkIt: "Verifie",
      copyAccountNumber: "Kopie nimero kont",
      earlier: "Pli boner",
      notifications: "Bann notifikasion",
      youHave: "Ou ena",
      bookNow: "Rezerve",
      ...
      youAreHere: "Ou isi",
      liveLocationOnly: "Pozision direk marse zis kan ou lor lil Rodrigues.",
      noAccountNeeded: "Pa bizin kont. Li marse mem si sa paz la ferme.",
      notificationsBlocked: "Bann notifikasion bloke pou sa sit la dan ou navigater.",
      notificationPrefs: "Swazir lor ki ou anvi tande. Kan ou tengn enn, sa aret notifikasion la, pa servis la.",
      collectFromKitchen: "Al pran li kot lakwizinn. Pena fre, ek ou gagn enn kod pou montre kan ou arive.",
      collectionOnly: "Zis pou al pran la",
      deliveryPaused: "— livrezon inn arete.",
      chipPickup: "Al pran li limem",
      chipDelivered: "Livre kot ou",
      weBringItToYou: "Nou amenn li kot ou",
      weBringItFrom: "sa depann kot ou ete.",
      shareLocationAtCheckout: "Ou donn nou ou plas kan ou pey.",
      aiTripPlanner: "Planifikater vwayaz",
      chooseExperience: "Swazir kouma ou anvi viv Rodrigues",
      afterDark: "APRE FER NWAR",
      curatedByLocals: "RODRIGUES · SWAZIR PAR BANN DIMOUNN ISI",
      bookScooter: "Rezerv enn skouter",
      downloadReceipt: "Telsarz resi",
      tapOneDay: "Tap enn zour pou enn lokasion enn zour, ouswa tap zour retour pou enn pli long vwayaz.",
      validEmail: "Met enn adres e-mail korek souple.",
    },
    a11yMore: {
      liveTrackingMap: "Kart swivi direk",
      mapStyle: "Stil kart",
      islandGuideMap: "Kart gid lil",
      heroSection: "Seksion prinsipal",
      heroAlt: "Lil Rodrigues ler soley pe kouse",
      marquee: "EXPLOR LIL LA • SANT LEVAN • ROULE RODRIGUES •",
      vehicleFleet: "Nou bann veikil",
      recommendedPlaces: "Bann plas rekomande",
      nextMonth: "Mwa swivan",
      prevMonth: "Mwa avan",
      tripProgress: "Progre trazet",
      pickupQr: "Kod QR pou sa ranmasaz la — skane kot kontwar kan ou vinn pran",
      whatsappChat: "Koz avek nou lor WhatsApp",
      emergencyNumbers: "Nimero irzans ek nimero itil",
      ourPartners: "Nou bann partener",
      appearance: "Aparans",
      islandEvents: "Bann levennman lil",
      gettingAround: "Deplas dan Rodrigues",
      faq: "Bann kestion frekan",
    },
},
} as const;
