...
const translations = {
  en: {
    ...
    listing: {
      ...
      whatToListLabel: "WHAT DO YOU WANT TO LIST?",
      yourName: "Your name",
      phone: "Phone / WhatsApp",
      yourArea: "Your area",
      tellUs: "Tell us what you have",
      anythingElse: "Anything else we should know?",
      optional: "Optional",
      byApproval: "BY APPROVAL ONLY",
      approvalNeeded: "Approval needed",
      reviewedFirst: "This one is reviewed before it goes live",
      received: "Application received",
      notLiveYet: "Nothing is live yet. We will be in touch first.",
      openShop: "Open a shop",
      sellingProducts: "Selling products? Open your shop now",
      partnerAgreement: "Partner Agreement",
      removeFile: "Remove file",
      organiserInvite: "Your organiser invite is sent to this address.",
    },
    partnerPortal: {
      ...
      noBookings: "No bookings yet — share your link to get started!",
      rentalEstimate: "Rental value is an estimate based on the booking requests sent through your link.",
    ...
    account: {
      ...
      noAccountNeeded: "You don’t need an account to order or to check where something is.",
      findOrder: "Find an order or booking",
      ...
      everythingOrdered: "Everything I’ve ordered",
      myBasket: "My basket",
      notifications: "Notifications",
      changePassword: "Change my password",
      helpGuides: "Help, guides & language",
    ...
    resetPassword: {
      ...
      takingYou: "Taking you to sign in…",
    ...
    ordersPage: {
      ...
      partialError: "Some of your bookings could not be loaded just now. Nothing is lost — please refresh in a moment.",
    ...
    rating: {
      ...
      whatWasItLike: "What was it like?",
      sayWhy: "Say why, if you like (optional)",
      onlyCollectedProducts: "Only someone who collected an order can rate its products — so your rating counts.",
      publishedProducts: "Published straight away under your first name. Each product can be rated once per order.",
      thanksRatings: "Thank you — your ratings are live",
      showOnProduct: "They show on each product’s page and help the next buyer choose.",
      tellTraveller: "Anything you’d tell another traveller?",
      onlyCollectedShop: "Only customers who actually collected an order can review — so your rating counts.",
      publishedShop: "Published straight away under your first name and last initial. You can review each order once.",
      thanks: "Thank you",
      reviewExample: "The honey was the best I found on the island…",
    },
    receipt: {
      addReceipt: "Add your transfer receipt",
      chooseFile: "Choose file",
      preview: "Receipt preview",
      removeReplace: "Remove / replace",
      askProof: "They ask for proof of payment before confirming.",
    ...
    buyAgain: {
      ...
      checking: "Checking what’s still available…",
      addEverything: "Add everything still available",
      nothingOnSale: "Nothing from this order is on sale at the moment.",
    },
    bankPanel: {
      payByTransfer: "Pay by bank transfer",
      transferExactly: "Transfer exactly",
      awaiting: "Awaiting confirmation",
      noBankDetails: "They haven’t published bank details yet. Please contact them before transferring.",
    },
    dish: {
    ...
    a11y: {
      ...
      home: "Roule Rodrigues home",
      changeCurrency: "Change currency",
      changeLanguage: "Change language",
      savedList: "Your saved list",
      about: "About Roule Rodrigues",
      primary: "Primary",
      ...
      reviewsAndContact: "Reviews and contact",
    },
    phoneInput: {
    ...
    refundBank: {
      ...
      bankName: "Bank name",
      bankOptional: "Bank (optional, e.g. MCB)",
    },
},
  ...
  fr: {
    ...
    listing: {
      ...
      getDiscovered: "Faites-vous connaître.",
      listIt: "Proposez-le.",
      whatToList: "Que voulez-vous proposer ?",
      whatToListLabel: "QUE VOULEZ-VOUS PROPOSER ?",
      yourName: "Votre nom",
      phone: "Téléphone / WhatsApp",
      yourArea: "Votre région",
      tellUs: "Dites-nous ce que vous avez",
      anythingElse: "Autre chose à nous signaler ?",
      optional: "Facultatif",
      byApproval: "SUR VALIDATION UNIQUEMENT",
      approvalNeeded: "Validation nécessaire",
      reviewedFirst: "Celui-ci est vérifié avant d’être publié",
      received: "Demande reçue",
      notLiveYet: "Rien n’est encore en ligne. Nous vous contactons d’abord.",
      openShop: "Ouvrir une boutique",
      sellingProducts: "Vous vendez des produits ? Ouvrez votre boutique",
      partnerAgreement: "Contrat de partenariat",
      removeFile: "Retirer le fichier",
      organiserInvite: "Votre invitation d’organisateur est envoyée à cette adresse.",
    },
    partnerPortal: {
      portal: "ESPACE PARTENAIRE",
      ...
      noBookings: "Pas encore de réservation — partagez votre lien pour commencer !",
      rentalEstimate: "La valeur de location est une estimation basée sur les demandes envoyées via votre lien.",
    ...
    account: {
      ...
      noAccountNeeded: "Pas besoin de compte pour commander ou pour savoir où en est votre commande.",
      findOrder: "Trouver une commande ou une réservation",
      haveAccount: "VOUS AVEZ UN COMPTE ?",
      signIn: "Se connecter",
      signOut: "Se déconnecter",
      createAccount: "Créer un compte",
      startHere: "Commencer ici",
      myDashboards: "MES ESPACES",
      everythingOrdered: "Tout ce que j’ai commandé",
      myBasket: "Mon panier",
      notifications: "Notifications",
      changePassword: "Changer mon mot de passe",
      helpGuides: "Aide, guides et langue",
    ...
    ordersPage: {
      ...
      partialError: "Certaines de vos réservations n’ont pas pu être chargées. Rien n’est perdu — actualisez dans un instant.",
    ...
    rating: {
      ...
      whatWasItLike: "C’était comment ?",
      sayWhy: "Dites pourquoi, si vous voulez (facultatif)",
      onlyCollectedProducts: "Seule une personne ayant récupéré une commande peut noter les produits — votre avis compte donc vraiment.",
      publishedProducts: "Publié aussitôt sous votre prénom. Chaque produit peut être noté une fois par commande.",
      thanksRatings: "Merci — vos notes sont en ligne",
      showOnProduct: "Elles apparaissent sur la page de chaque produit et aident le prochain acheteur.",
      tellTraveller: "Quelque chose à dire à un autre voyageur ?",
      onlyCollectedShop: "Seuls les clients ayant réellement récupéré une commande peuvent laisser un avis — le vôtre compte donc vraiment.",
      publishedShop: "Publié aussitôt sous votre prénom et l’initiale de votre nom. Un avis par commande.",
      thanks: "Merci",
      reviewExample: "Le miel était le meilleur que j’ai trouvé sur l’île…",
    },
    receipt: {
      addReceipt: "Ajoutez votre reçu de virement",
      chooseFile: "Choisir un fichier",
      preview: "Aperçu du reçu",
      removeReplace: "Retirer / remplacer",
      askProof: "Ils demandent une preuve de paiement avant de confirmer.",
      uploading: "Envoi du reçu",
    },
    ordersFilter: {
      allStatuses: "Tous les statuts",
      filterByStatus: "Filtrer par statut",
      searchPlaceholder: "Chercher un numéro de commande…",
      searchOrders: "Chercher des commandes",
    },
    deliveryCard: {
    ...
    buyAgain: {
      buyItAgain: "Racheter",
      checking: "Vérification de ce qui est encore disponible…",
      addEverything: "Ajouter tout ce qui reste disponible",
      nothingOnSale: "Rien de cette commande n’est en vente en ce moment.",
    },
    bankPanel: {
      payByTransfer: "Payer par virement bancaire",
      transferExactly: "Virez exactement",
      awaiting: "En attente de confirmation",
      noBankDetails: "Ils n’ont pas encore publié leurs coordonnées bancaires. Contactez-les avant de virer.",
    },
    dish: {
    ...
    a11y: {
      ...
      home: "Accueil Roule Rodrigues",
      changeCurrency: "Changer de devise",
      changeLanguage: "Changer de langue",
      savedList: "Votre liste enregistrée",
      about: "À propos de Roule Rodrigues",
      primary: "Principal",
      ...
      reviewsAndContact: "Avis et contact",
    },
    phoneInput: {
      selectCode: "Choisir l’indicatif du pays",
    ...
    refundBank: {
      ...
      bankOptional: "Banque (facultatif, ex. MCB)",
    },
},
  ...
  cr: {
    ...
    listing: {
      eyebrow: "VINN PARTENER AVEK NOU",
      getDiscovered: "Fer dimounn konn ou.",
      listIt: "Met li lor sit la.",
      whatToList: "Ki ou anvi propoze ?",
      whatToListLabel: "KI OU ANVI PROPOZE ?",
      yourName: "Ou nom",
      phone: "Telefonn / WhatsApp",
      yourArea: "Ou landrwa",
      tellUs: "Dir nou ki ou ena",
      anythingElse: "Ena lot kiksoz nou bizin kone ?",
      optional: "Si ou anvi",
      byApproval: "BIZIN VALIDE AVAN",
      approvalNeeded: "Bizin validasion",
      reviewedFirst: "Nou verifie sa avan li paret lor sit la",
      received: "Nou finn gagn ou demann",
      notLiveYet: "Nanye pankor lor sit la. Nou pou kontakt ou avan.",
      openShop: "Ouver enn laboutik",
      sellingProducts: "Ou vann prodwi ? Ouver ou laboutik",
      partnerAgreement: "Kontra partener",
      removeFile: "Tir fisye la",
      organiserInvite: "Ou invitasion organizater pou ale lor sa adres la.",
    },
    partnerPortal: {
      portal: "LESPAS PARTENER",
      dashboard: "TABLO PARRAINAZ",
      yourLink: "OU LIEN PARRAINAZ",
      recentBookings: "BANN REZERVASION RESAN",
      yourReferrals: "Ou bann parrainaz",
      referralQr: "QR parrainaz",
      downloadQr: "Telsarz QR",
      shareWhatsapp: "Partaz lor WhatsApp",
      noBookings: "Pankor ena rezervasion — partaz ou lien pou koumanse !",
      rentalEstimate: "Valer lokasion la enn estimasion baze lor bann demann ki finn pas par ou lien.",
    ...
    account: {
      ...
      noAccountNeeded: "Ou pa bizin enn kont pou komande ouswa pou get kot ou komand ete.",
      findOrder: "Trouv enn komand ouswa enn rezervasion",
      haveAccount: "OU ENA ENN KONT ?",
      signIn: "Konekte",
      signOut: "Dekonekte",
      createAccount: "Kree enn kont",
      startHere: "Koumans isi",
      myDashboards: "MO BANN LESPAS",
      everythingOrdered: "Tou seki mo finn komande",
      myBasket: "Mo panye",
      notifications: "Bann notifikasion",
      changePassword: "Chanz mo modpas",
      helpGuides: "Led, gid ek lang",
    ...
    resetPassword: {
      checkingLink: "Nou pe verifie ou lien…",
      chooseNew: "Swazir enn nouvo modpas",
      newPasswordLabel: "NOUVO MODPAS",
      newPassword: "Nouvo modpas",
      confirmNew: "Konfirm nouvo modpas",
      atLeast8: "Omwin 8 karakter.",
      updated: "Modpas finn chanze",
      takingYou: "Nou pe amenn ou lor koneksion…",
      requestNew: "Demann enn nouvo lien",
      backToSignIn: "Retourn lor koneksion",
    },
    ordersPage: {
      myAccount: "MO KONT",
      ...
      partialError: "Sertin rezervasion pa finn sarze la. Nanye pa perdi — refres dan enn ti moman.",
      backToOrders: "Retourn lor bann komand",
      noPayment: "Okenn peyman anrezistre.",
      timeRemaining: "Letan ki reste :",
    ...
    rating: {
      ...
      whatWasItLike: "Kouma li ti ete ?",
      sayWhy: "Dir kifer, si ou anvi (si ou anvi)",
      onlyCollectedProducts: "Zis enn dimounn ki finn rekiper enn komand kapav not bann prodwi — alor ou not konte vremem.",
      publishedProducts: "Pibliye deswit anba ou prenom. Sak prodwi kapav gagn enn not par komand.",
      thanksRatings: "Mersi — ou bann not lor sit la",
      showOnProduct: "Zot paret lor paz sak prodwi ek zot ed lot dimounn swazir.",
      tellTraveller: "Ena kiksoz ou ti pou dir enn lot vwayazer ?",
      onlyCollectedShop: "Zis bann kliyan ki finn vremem rekiper enn komand kapav donn enn avi — alor ou not konte vremem.",
      publishedShop: "Pibliye deswit anba ou prenom ek premie let ou nom. Enn avi par komand.",
      thanks: "Mersi",
      reviewExample: "Dimiel la ti pli bon ki mo finn trouve lor lil…",
    },
    receipt: {
      addReceipt: "Met ou resi viraman",
      chooseFile: "Swazir enn fisye",
      preview: "Apersi resi",
      removeReplace: "Tire / ranplase",
      askProof: "Zot demann enn prev peyman avan zot konfirme.",
      uploading: "Pe avoy resi",
    },
    ordersFilter: {
      allStatuses: "Tou bann stati",
      filterByStatus: "Filtre par stati",
      searchPlaceholder: "Rod enn nimero komand…",
      searchOrders: "Rod bann komand",
    },
    deliveryCard: {
    ...
    buyAgain: {
      ...
      checking: "Nou pe get seki ankor disponib…",
      addEverything: "Azout tou seki ankor disponib",
      nothingOnSale: "Nanye dan sa komand la pa pe vande la.",
    },
    bankPanel: {
      payByTransfer: "Peye par viraman bankier",
      transferExactly: "Vir exakteman",
      awaiting: "Pe atann konfirmasion",
      noBankDetails: "Zot pankor met zot detay bankier. Kontakt zot avan ou vire.",
    },
    dish: {
      chooseSize: "SWAZIR ENN GRANDER",
      addToOrder: "Azout dan komand",
      oneMore: "Enn deplis",
      oneFewer: "Enn demwin",
      seeReady: "Get seki pare la",
    },
    a11y: {
      openMenu: "Ouver meni",
      closeMenu: "Ferm meni",
      home: "Lakey Roule Rodrigues",
      changeCurrency: "Chanz deviz",
      changeLanguage: "Chanz lang",
      savedList: "Ou lalis sove",
      about: "Lor Roule Rodrigues",
      primary: "Prinsipal",
      siteFooter: "Pie paz",
      nextPhoto: "Foto swivan",
      prevPhoto: "Foto avan",
      noPhoto: "Pena foto",
      askQuestion: "Poz enn kestion",
      nextReviews: "Bann avi swivan",
      prevReviews: "Bann avi avan",
      reviewsAndContact: "Avi ek kontak",
    },
    phoneInput: {
      selectCode: "Swazir kod pei",
      searchCountry: "Rod enn pei",
      searchCountryPlaceholder: "Rod enn pei…",
      noMatch: "Pa finn trouve",
    },
    refundBank: {
      accountHolder: "Nom dimounn ki ena kont la",
      accountNumber: "Nimero kont",
      bankName: "Nom labank",
      bankOptional: "Labank (si ou anvi, ex. MCB)",
    },
},
} as const;
