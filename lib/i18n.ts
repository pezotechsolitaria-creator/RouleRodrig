...
const translations = {
  en: {
    ...
    booking: {
      ...
      successDesc:    "Your dates are not held yet — whoever pays the deposit first secures the vehicle. Pay below to lock it in, or we'll follow up on WhatsApp shortly.",
  ...
  fr: {
    ...
    booking: {
      ...
      successDesc:    "Vos dates ne sont pas encore bloquées — le premier qui paie l'acompte obtient le véhicule. Payez ci-dessous pour le réserver, ou nous vous recontactons sur WhatsApp.",
  ...
  cr: {
    ...
    booking: {
      ...
      successDesc:    "Ou bann dat pa ankor blok — premie ki pey depo gagn veikil la. Pey anba pou blok li, ouswa nou kontakte ou lor WhatsApp.",
