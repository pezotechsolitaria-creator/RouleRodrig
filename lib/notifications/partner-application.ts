...
function html(heading: string, paragraphs: string[], cta?: { url: string; label: string }) {
  ...
  ${cta ? `<p style="margin:24px 0 0"><a href="${cta.url}" style="background:#2F80ED;color:#1a1a1a;text-decoration:none;font-weight:bold;padding:12px 22px;border-radius:999px;display:inline-block">${escapeHtml(cta.label)}</a></p>` : ""}
