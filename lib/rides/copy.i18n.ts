...
const EN = {
  book: {
    ...
    step3: {
      ...
      phoneInvalid: "That doesn't look like a number your driver can call. A Mauritian number has 8 digits — check it and try again.",
  ...
  track: {
    live: {
      ...
      noPoints: "We don't have the map points for this trip yet.",
      finished: "This trip has finished.",
      pickup: "Pickup",
      destination: "Destination",
      hideDetails: "Hide details",
      showDetails: "Show details",
      thisIsYourRoute: "This is your route.",
      reconnecting: "Reconnecting — the map may lag",
      liveBadge: "Live",
      booking: "BOOKING",
      from: "FROM",
      fare: "FARE",
...
const FR: RidesCopy = {
  book: {
    ...
    step3: {
      ...
      phonePlaceholder: "+230 5XXX XXXX",
      phoneInvalid: "Ce numéro ne semble pas joignable par votre chauffeur. Un numéro mauricien compte 8 chiffres — vérifiez et réessayez.",
  ...
  track: {
    live: {
      ...
      noPoints: "Nous n'avons pas encore les points de ce trajet.",
      finished: "Ce trajet est terminé.",
      pickup: "Prise en charge",
      destination: "Destination",
      hideDetails: "Masquer les détails",
      showDetails: "Voir les détails",
      thisIsYourRoute: "Voici votre trajet.",
      reconnecting: "Reconnexion — la carte peut être en retard",
      liveBadge: "En direct",
      booking: "RÉSERVATION",
      from: "DEPUIS",
      fare: "TARIF",
...
const CR: RidesCopy = {
  book: {
    ...
    step3: {
      ...
      phonePlaceholder: "+230 5XXX XXXX",
      phoneInvalid: "Sa nimero-la pa paret bon pou ou sofer apele. Enn nimero morisien ena 8 sif — verifie li ek sey ankor.",
  ...
  track: {
    live: {
      ...
      tracking: "Swivi",
      yourDriver: "Ou sofer",
      noPoints: "Nou pankor ena bann pwin pou sa trazet la.",
      finished: "Sa trazet la fini.",
      pickup: "Kot pran ou",
      destination: "Destinasion",
      hideDetails: "Kasiet detay",
      showDetails: "Montre detay",
      thisIsYourRoute: "Sa se ou trazet.",
      reconnecting: "Pe rekonekte — kart la kapav an reta",
      liveBadge: "An direk",
      booking: "REZERVASION",
      from: "DEPI",
      fare: "PRI",
